...
export default function Home() {
  return <>
    <section className="hero"><div className="shell hero-grid">
      <div className="hero-copy"><p className="eyebrow">Connected fitness equipment infrastructure</p><h1>One connected lifecycle for every machine.</h1><p className="lead">L4Gym is building the infrastructure that connects fitness equipment, gym operations and technical service — from installation to repair, resale and beyond.</p><div className="button-row"><Link className="button primary" href="/what-we-do">Explore L4Gym <ArrowRight size={18}/></Link><a className="button secondary" href="mailto:jamie@l4gym.com">Discuss a partnership</a></div></div>
    ...
    <section className="section shell"><div className="section-heading split"><div><p className="eyebrow">The operating layer</p><h2>Equipment is the common thread.</h2></div><p>Machines move through manufacturers, distributors, gyms, technicians and new owners. L4Gym is designed to keep the right information connected through that journey.</p></div><div className="three-grid">
      <article className="feature dark"><QrCode/><p className="kicker">01 / Identify</p><h3>Give each machine a persistent identity.</h3><p>MachineDNA links an equipment record to a durable QR code for quick, permission-aware access.</p><Link href="/machinedna">Explore MachineDNA <ArrowRight size={16}/></Link></article>
      <article className="feature"><Wrench/><p className="kicker">02 / Maintain</p><h3>Connect faults to technical action.</h3><p>Structured reporting helps service teams understand the machine, issue and history before work begins.</p><Link href="/service-support">Service and support <ArrowRight size={16}/></Link></article>
      <article className="feature"><Factory/><p className="kicker">03 / Extend</p><h3>Support the whole equipment lifecycle.</h3><p>Installation, servicing, ownership changes and resale can contribute to one continuous machine record.</p><Link href="/equipment">Equipment lifecycle <ArrowRight size={16}/></Link></article>
    </div></section>
